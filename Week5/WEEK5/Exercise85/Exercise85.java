...
public class Exercise85 {
	public static void main(String[] args) {
	    ...
	    System.out.println("total weights measured "+ eastHelsinkiReformatory.totalWeightsMeasured()); // 2

	    eastHelsinkiReformatory.weight(brian);
	    eastHelsinkiReformatory.weight(pekka);

	    System.out.println("total weights measured "+ eastHelsinkiReformatory.totalWeightsMeasured()); // 4
	    ...
	    System.out.println("total weights measured "+ eastHelsinkiReformatory.totalWeightsMeasured()); // 6
	}
}
